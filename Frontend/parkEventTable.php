      ...
      if(isset($_POST['viewAll_btn']))
      {
        ...
        echo "<table>";
			...
			else if(isset($_POST['update_btn']))
			{
				...
				if($_POST['eid'] == "" || $_POST['date'] == "" || $_POST['eventtype'] == "" || $_POST['starttime'] == "" || $_POST['endtime'] == "" || $_POST['totalprice'] == "" || $_POST['numguests'] == "" || $_POST['eventareaid'] == "" || $_POST['customerbooked'] == "")
				{
				...
				else
				{
					...
					$query = "update PARK_EVENT SET Event_Date = '$date', Event_Type = '$eventtype', Event_Start_Time = '$starttime', Event_End_Time = '$endtime', Total_Price = $totalprice, Num_guests = $numguests, Event_area_ID = $eventareaid, Cust_booked = $customerbooked WHERE Event_ID = $eid";
					$query_run = mysqli_query($conn,$query);
